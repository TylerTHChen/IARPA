...
#
# Script generated by Vivado on Wed Jul 17 11:04:21 -0500 2024
...
#
# Usage        : waves.sh
#                waves.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                waves.sh [-reset_run]
#                waves.sh [-reset_log]
#                waves.sh [-help]
#
...
#                script (type 'waves.sh -help' for more information).
#
...
# script info
echo -e "waves.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./waves.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  "../../../../../../../../OneDrive/ -/ UW-Madison/Research/IARPA/QMOD_GDS/waves.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.waves xil_defaultlib.glbl -o waves_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./waves_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key waves_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc waves_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./waves.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: waves.sh [-help]\n\
Usage: waves.sh [-step]\n\
Usage: waves.sh [-lib_map_path]\n\
Usage: waves.sh [-reset_run]\n\
Usage: waves.sh [-reset_log]\n\
Usage: waves.sh [-keep_index]\n\
Usage: waves.sh [-noclean_files]\n\n\
