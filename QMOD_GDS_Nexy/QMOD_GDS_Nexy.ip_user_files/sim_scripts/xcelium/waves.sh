...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../QMOD_GDS_Nexy.gen/sources_1/ip/clk_wiz_0_1" \
  "../../../../waves.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.waves xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.waves -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log waves_sc.so .tmp_log xcelium_lib waves.shm c.obj)
