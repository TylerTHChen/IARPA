...
HD_PWD='C:/Users/tyler_hyposvu/OneDrive - UW-Madison/Research/IARPA/QMOD_GDS/QMOD_GDS_Nexy/QMOD_GDS_Nexy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log waves.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source waves.tcl -notrace
