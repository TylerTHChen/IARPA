...
HD_PWD='C:/Users/tyler_hyposvu/OneDrive - UW-Madison/Research/IARPA/QMOD_GDS/QMOD_GDS_Nexy/QMOD_GDS_Nexy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log waves.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source waves.tcl
